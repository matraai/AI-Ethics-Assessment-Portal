...
`:`
`)),l=!P):(c!==1&&n||!u&&_t(s,"objects")&&y.getValue().type!=="RestElement")&&r.push(a),p++},g)}),t.inexact){let g=S("...",s);u?(c>0&&r.push(a," "),r.push(g)):r.push(`
...
`),i.each(function(u){let h=u.getName();if(!u.getValue())r.push(",");else{let d=o[h];c?h>0&&r.push(" "):d=d.indent(s.tabWidth),r.push(d),(h<a-1||!c&&_t(s,"arrays"))&&r.push(","),c||r.push(`
`)}},"elements"),c&&s.arrayBracketSpacing?r.push(" ]"):r.push("]"),t.typeAnnotation&&r.push(i.call(e,"typeAnnotation")),x(r)}case"SequenceExpression":return S(", ").join(i.map(e,"expressions"));case"ThisExpression":return S("this");case"Super":return S("super");case"NullLiteral":return S("null");case"RegExpLiteral":return S(pt(t)||`/${t.pattern}/${t.flags||""}`,s);case"BigIntLiteral":return S(pt(t)||t.value+"n",s);case"NumericLiteral":return S(pt(t)||t.value,s);case"DecimalLiteral":return S(pt(t)||t.value+"m",s);case"StringLiteral":return S(Mt(t.value,s));case"BooleanLiteral":case"Literal":return S(pt(t)||(typeof t.value=="string"?Mt(t.value,s):t.value),s);case"Directive":return i.call(e,"value");case"DirectiveLiteral":return S(pt(t)||Mt(t.value,s),s);case"InterpreterDirective":return S(`#!${t.value}
`,s);case"ModuleSpecifier":if(t.local)throw new Error("The ESTree ModuleSpecifier type should be abstract");return S(Mt(t.value,s),s);case"UnaryExpression":return r.push(t.operator),/[a-z]$/.test(t.operator)&&r.push(" "),r.push(i.call(e,"argument")),x(r);case"UpdateExpression":return r.push(i.call(e,"argument"),t.operator),t.prefix&&r.reverse(),x(r);case"ConditionalExpression":return x([i.call(e,"test")," ? ",i.call(e,"consequent")," : ",i.call(e,"alternate")]);case"NewExpression":return r.push("new ",i.call(e,"callee")),t.typeParameters&&r.push(i.call(e,"typeParameters")),t.typeArguments&&r.push(i.call(e,"typeArguments")),t.arguments&&r.push(fn(i,s,e)),x(r);case"VariableDeclaration":{t.declare&&r.push("declare "),r.push(t.kind," ");let n=0,a=i.map(function(l){let c=e(l);return n=Math.max(c.length,n),c},"declarations");n===1?r.push(S(", ").join(a)):a.length>1?r.push(S(`,
...
`).join(i.map(e,"body").map(a=>Vt(a)!==";"?a.concat(";"):a));return n.isEmpty()?S("{}",s):x([`{
`,n.indent(s.tabWidth),`
...
`).join(n),_t(s,"parameters")&&!t.rest&&r[r.length-1].type!=="RestElement"?a=x([a,`,
`]):a=x([a,`
`]),x([`
...
`,c,`
}`):s.objectCurlySpacing?r.push("{ ",c," }"):r.push("{",c,"}")}}else r.push(n?"{ ":"{",S(", ").join(i.map(e,"specifiers")),n?" }":"}");t.source&&r.push(" from ",i.call(e,"source"),Jn(i,s,e))}let a=x(r);return Vt(a)!==";"&&!(t.declaration&&(t.declaration.type==="FunctionDeclaration"||t.declaration.type==="ClassDeclaration"||t.declaration.type==="TSModuleDeclaration"||t.declaration.type==="TSInterfaceDeclaration"||t.declaration.type==="TSEnumDeclaration"))&&(a=x([a,";"])),a}function Dt(i,s){return Nn(i)||s.unshift("declare "),x(s)}function Ot(i,s){return i.call(function(e){let t=e.getValue();return t?t==="plus"?S("+"):t==="minus"?S("-"):s(e):S("")},"variance")}function Ke(i,s){return i.length>1?x([" ",i]):x([`
`,fs(i).indent(s.tabWidth)])}function Vt(i){let s=i.lastPos();do{let e=i.charAt(s);if(/\S/.test(e))return e}while(i.prevPos(s))}function mn(i){return Vt(i)==="}"}function ls(i){return i.replace(/['"]/g,s=>s==='"'?"'":'"')}function pt(i){let s=Be(i,"value"),e=Be(i,"extra");if(e&&typeof e.raw=="string"&&s==e.rawValue)return e.raw;if(i.type==="Literal"){let t=i.raw;if(typeof t=="string"&&s==t)return t}}function cs(i){return JSON.stringify(i).replace(/[\u2028\u2029]/g,function(s){return"\\u"+s.charCodeAt(0).toString(16)})}function Mt(i,s){switch(Vr.assert(i),s.quote){case"auto":{let e=cs(i),t=ls(cs(ls(i)));return e.length>t.length?t:e}case"single":return ls(cs(ls(i)));case"double":default:return cs(i)}}function fs(i){let s=Vt(i);return!s||`
};`.indexOf(s)<0?x([i,";"]):i}function bc(i,s){return new mc(s).print(i)}var us;function Kn(){if(us)return us;let i=Tc();return us={parse(s,e){return gn.parse(s,{...i,...e})}},us}function Tc(){return{sourceType:"module",strictMode:!1,allowImportExportEverywhere:!0,allowReturnOutsideFunction:!0,startLine:1,tokens:!0,plugins:["asyncGenerators","bigInt","classPrivateMethods","classPrivateProperties","classProperties","classStaticBlock","decimal","decorators-legacy","doExpressions","dynamicImport","exportDefaultFrom","exportExtensions","exportNamespaceFrom","functionBind","functionSent","importAssertions","importMeta","nullishCoalescingOperator","numericSeparator","objectRestSpread","optionalCatchBinding","optionalChaining",["pipelineOperator",{proposal:"minimal"}],["recordAndTuple",{syntaxType:"hash"}],"throwExpressions","topLevelAwait","v8intrinsic","jsx","typescript"]}}var Pc=Object.defineProperty,Sc=(i,s,e)=>s in i?Pc(i,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[s]=e,yn=(i,s,e)=>(Sc(i,typeof s!="symbol"?s+"":s,e),e),se=class extends Error{constructor(s,e){if(super(""),yn(this,"rawMessage"),yn(this,"options"),this.name="MagicastError",this.rawMessage=s,this.options=e,e?.ast&&e?.code&&e.ast.loc){let{line:t,column:r}=e.ast.loc.start,n=e.code.split(`
`),a=Math.max(0,t-3),o=Math.min(n.length,t+3),l=n.slice(a,o).map((c,u)=>(c=`${(a+u+1).toString().padStart(3," ")} | ${c}`,a+u===t-1&&(c+=`
${" ".repeat(6+r)}^`),c));s+=`

${l.join(`
`)}
`}this.message=s}},Ec=new Set(["Literal","StringLiteral","NumericLiteral","BooleanLiteral","NullLiteral","RegExpLiteral","BigIntLiteral"]),Hn=new Set(["string","number","boolean","bigint","symbol","undefined"]),Z=mt;function Ac(i){return/^[$A-Z_a-z][\w$]*$/.test(i)}var $r="__magicast_proxy";function le(i,s=new Set){if(i===void 0)return Z.identifier("undefined");if(i===null)return Z.literal(null);if(Hn.has(typeof i))return Z.literal(i);if(s.has(i))throw new se("Can not serialize circular reference");if(s.add(i),i[$r])return i.$ast;if(i instanceof RegExp){let e=Z.regExpLiteral(i.source,i.flags);return delete e.extra.raw,e}return i instanceof Set?Z.newExpression(Z.identifier("Set"),[Z.arrayExpression([...i].map(e=>le(e,s)))]):i instanceof Date?Z.newExpression(Z.identifier("Date"),[Z.literal(i.toISOString())]):i instanceof Map?Z.newExpression(Z.identifier("Map"),[Z.arrayExpression([...i].map(([e,t])=>Z.arrayExpression([le(e,s),le(t,s)])))]):Array.isArray(i)?Z.arrayExpression(i.map(e=>le(e,s))):typeof i=="object"?Z.objectExpression(Object.entries(i).map(([e,t])=>Z.property("init",/^[$A-Z_a-z][\w$]*$/g.test(e)?Z.identifier(e):Z.literal(e),le(t,s)))):Z.literal(i)}function wc(i,s={}){let e=s;return e[$r]=!0,e.$ast=i,e.$type||(e.$type="object"),e}var vc={enumerable:!0,configurable:!0};function xe(i,s,e){let t=wc(i,s);return new Proxy({},{ownKeys(){return Object.keys(t).filter(r=>r!==$r&&!r.startsWith("$"))},getOwnPropertyDescriptor(){return vc},has(r,n){return n in t},...e,get(r,n,a){if(n in t)return t[n];if(e.get)return e.get(r,n,a)},set(r,n,a,o){return n in t?(t[n]=a,!0):e.set?e.set(r,n,a,o):!1}})}var fe=mt,vr=new WeakMap;function Cc(i,s,e){if(vr.has(s))return vr.get(s);let t=xe(s,{get $declaration(){return i},get imported(){return s.type==="ImportDefaultSpecifier"?"default":s.type==="ImportNamespaceSpecifier"?"*":s.imported.type==="Identifier"?s.imported.name:s.imported.value},set imported(r){if(s.type!=="ImportSpecifier")throw new se("Changing import name is not yet implemented");s.imported.type==="Identifier"?s.imported.name=r:s.imported.value=r},get local(){return s.local.name},set local(r){s.local.name=r},get from(){return i.source.value},set from(r){if(r===i.source.value)return;i.specifiers=i.specifiers.filter(a=>a!==s),i.specifiers.length===0&&(e.body=e.body.filter(a=>a!==i));let n=e.body.find(a=>a.type==="ImportDeclaration"&&a.source.value===r);n?n.specifiers.push(s):e.body.unshift(fe.importDeclaration([s],fe.stringLiteral(r)))},toJSON(){return{imported:this.imported,local:this.local,from:this.from}}},{ownKeys(){return["imported","local","from","toJSON"]}});return vr.set(s,t),t}function Ic(i,s){let e=()=>{let a=[];for(let o of i.body)if(o.type==="ImportDeclaration")for(let l of o.specifiers)a.push(Cc(o,l,i));return a},t=(a,o,l)=>{let c=e(),u=c.find(p=>p.local===a),h=o.local||a;if(u)return u.imported=o.imported,u.local=h,u.from=o.from,!0;let f=o.imported==="default"?fe.importDefaultSpecifier(fe.identifier(h)):o.imported==="*"?fe.importNamespaceSpecifier(fe.identifier(h)):fe.importSpecifier(fe.identifier(o.imported),fe.identifier(h)),d=c.find(p=>p.from===o.from)?.$declaration;if(d)d.specifiers.push(f);else if(l==="prepend"||c.length===0)i.body.unshift(fe.importDeclaration([f],fe.stringLiteral(o.from)));else{let p=c.at(-1).$declaration,g=i.body.indexOf(p);i.body.splice(g+1,0,fe.importDeclaration([f],fe.stringLiteral(o.from)))}return!0},r=a=>{let o=e().find(u=>u.local===a);if(!o)return!1;let l=o.$declaration,c=o.$ast;return l.specifiers=l.specifiers.filter(u=>u!==c),l.specifiers.length===0&&(i.body=i.body.filter(u=>u!==l)),!0};return xe(i,{$type:"imports",$add(a){t(a.local||a.imported,a,"prepend")},$prepend(a){t(a.local||a.imported,a,"prepend")},$append(a){t(a.local||a.imported,a,"append")},get $items(){return e()},toJSON(){return e().reduce((a,o)=>(a[o.local]=o,a),{})}},{get(a,o){return e().find(l=>l.local===o)},set(a,o,l){return t(o,l,"prepend")},deleteProperty(a,o){return r(o)},ownKeys(){return e().map(a=>a.local)},has(a,o){return e().some(l=>l.local===o)}})}function As(i,s,e){let t=n=>s[n],r=(n,a)=>{s[n]=a};return xe(i,{$type:"array",push(n){s.push(le(n))},pop(){return oe(s.pop(),e)},unshift(n){s.unshift(le(n))},shift(){return oe(s.shift(),e)},splice(n,a,...o){return s.splice(n,a,...o.map(c=>le(c))).map(c=>oe(c,e))},find(n){return s.map(a=>oe(a,e)).find(n)},findIndex(n){return s.map(a=>oe(a,e)).findIndex(n)},includes(n){return s.map(a=>oe(a,e)).includes(n)},toJSON(){return s.map(n=>oe(n,e))}},{get(n,a){if(a==="length")return s.length;if(a===Symbol.iterator)return function*(){for(let c of s)yield oe(c,e)};if(typeof a=="symbol")return;let o=+a;if(Number.isNaN(o))return;let l=t(o);if(l)return oe(l,e)},set(n,a,o){if(typeof a=="symbol")return!1;let l=+a;return Number.isNaN(l)?!1:(r(l,le(o)),!0)},deleteProperty(n,a){if(typeof a=="symbol")return!1;let o=+a;return Number.isNaN(o)?!1:(s[o]=le(void 0),!0)},ownKeys(){return["length",...s.map((n,a)=>a.toString())]}})}function Nc(i,s){if("elements"in i)return As(i,i.elements,s)}function Xn(i,s){if(i.type!=="CallExpression")throw new se("Not a function call");function e(r){if(r.type==="Identifier")return r.name;if(r.type==="MemberExpression")return`${e(r.object)}.${e(r.property)}`;throw new se("Not implemented")}let t=As(i,i.arguments,s);return xe(i,{$type:"function-call",$callee:e(i.callee),$args:t},{})}function kc(i,s){if(i.type!=="ArrowFunctionExpression")throw new se("Not an arrow function expression");let e=As(i,i.params,s);return xe(i,{$type:"arrow-function-expression",$params:e,$body:oe(i.body,s)},{})}var Lc=mt;function Dc(i,s){if(!("properties"in i))return;let e=n=>{for(let a of i.properties){if("key"in a&&"name"in a.key&&a.key.name===n)return a.value;if(a.type==="ObjectProperty"&&(a.key.type==="StringLiteral"||a.key.type==="NumericLiteral"||a.key.type==="BooleanLiteral")&&a.key.value.toString()===n)return a.value.value??a.value}},t=(n,a=!1)=>{if("key"in n&&"name"in n.key)return n.key.name;if(n.type==="ObjectProperty"&&(n.key.type==="StringLiteral"||n.key.type==="NumericLiteral"||n.key.type==="BooleanLiteral"))return n.key.value.toString();if(a)throw new se(`Casting "${n.type}" is not supported`,{ast:n,code:s?.$code})},r=(n,a)=>{let o=i.properties.find(l=>t(l)===n);o?o.value=a:Ac(n)?i.properties.push({type:"Property",key:{type:"Identifier",name:n},value:a}):i.properties.push({type:"ObjectProperty",key:Lc.stringLiteral(n),value:a})};return xe(i,{$type:"object",toJSON(){return i.properties.reduce((n,a)=>("key"in a&&"name"in a.key&&(n[a.key.name]=oe(a.value,s)),n),{})}},{get(n,a){let o=e(a);if(o)return oe(o,s)},set(n,a,o){return typeof a!="string"&&(a=String(a)),r(a,le(o)),!0},deleteProperty(n,a){typeof a!="string"&&(a=String(a));let o=i.properties.findIndex(l=>"key"in l&&"name"in l.key&&l.key.name===a);return o!==-1&&i.properties.splice(o,1),!0},ownKeys(){return i.properties.map(n=>t(n,!0)).filter(Boolean)}})}function Gn(i,s){if(i.type!=="NewExpression")throw new se("Not a new expression");function e(r){if(r.type==="Identifier")return r.name;if(r.type==="MemberExpression")return`${e(r.object)}.${e(r.property)}`;throw new se("Not implemented")}let t=As(i,i.arguments,s);return xe(i,{$type:"new-expression",$callee:e(i.callee),$args:t},{})}function Oc(i){if(i.type!=="Identifier")throw new se("Not an identifier");return xe(i,{$type:"identifier",$name:i.name},{})}function Mc(i){if(i.type!=="LogicalExpression")throw new se("Not a logical expression");return xe(i,{$type:"logicalExpression"},{})}function Fc(i){if(i.type!=="MemberExpression")throw new se("Not a member expression");return xe(i,{$type:"memberExpression"},{})}var Cr=new WeakMap;function oe(i,s){if(Hn.has(typeof i))return i;if(Ec.has(i.type))return i.value;if(Cr.has(i))return Cr.get(i);let e;switch(i.type){case"ObjectExpression":{e=Dc(i,s);break}case"ArrayExpression":{e=Nc(i,s);break}case"CallExpression":{e=Xn(i,s);break}case"ArrowFunctionExpression":{e=kc(i,s);break}case"NewExpression":{e=Gn(i,s);break}case"Identifier":{e=Oc(i);break}case"LogicalExpression":{e=Mc(i);break}case"MemberExpression":{e=Fc(i);break}case"TSAsExpression":case"TSSatisfiesExpression":{e=oe(i.expression,s);break}default:throw new se(`Casting "${i.type}" is not supported`,{ast:i,code:s?.$code})}return Cr.set(i,e),e}var Ft=mt;function Bc(i,s){let e=r=>{let n=r==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration";for(let a of i.body)if(a.type===n){if(r==="default")return a.declaration;if(a.declaration&&"declarations"in a.declaration){let o=a.declaration.declarations[0];if("name"in o.id&&o.id.name===r)return o.init}}},t=(r,n)=>{let a=r==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration",o=le(n);for(let l of i.body)if(l.type===a){if(r==="default"){l.declaration=o;return}if(l.declaration&&"declarations"in l.declaration){let c=l.declaration.declarations[0];if("name"in c.id&&c.id.name===r){c.init=o;return}}}i.body.push(r==="default"?Ft.exportDefaultDeclaration(o):Ft.exportNamedDeclaration(Ft.variableDeclaration("const",[Ft.variableDeclarator(Ft.identifier(r),o)])))};return xe(i,{$type:"exports"},{get(r,n){let a=e(n);if(a)return oe(a,s)},set(r,n,a){return t(n,a),!0},ownKeys(){return i.body.flatMap(r=>r.type==="ExportDefaultDeclaration"?["default"]:r.type==="ExportNamedDeclaration"&&r.declaration&&"declarations"in r.declaration?r.declaration.declarations.map(n=>"name"in n.id?n.id.name:""):[]).filter(Boolean)},deleteProperty(r,n){let a=n==="default"?"ExportDefaultDeclaration":"ExportNamedDeclaration";for(let o=0;o<i.body.length;o++){let l=i.body[o];if(l.type===a){if(n==="default")return i.body.splice(o,1),!0;if(l.declaration&&"declarations"in l.declaration){let c=l.declaration.declarations[0];if("name"in c.id&&c.id.name===n)return i.body.splice(o,1),!0}}}return!1}})}function _c(i,s){let e=i.program;if(e.type!=="Program")throw new se(`Cannot proxify ${i.type} as module`);let t={$code:s,$type:"module"},r=xe(e,t,{ownKeys(){return["imports","exports","generate"]}});return t.exports=Bc(e,r),t.imports=Ic(e),t.generate=n=>qr(r,n),r}function Qn(i,s={}){let e={wrapColumn:s.wrapColumn===void 0,indent:s.tabWidth===void 0||s.useTabs===void 0,quote:s.quote===void 0,arrowParens:s.arrowParensAlways===void 0,trailingComma:s.trailingComma===void 0},t=2,r=0,n=0,a=0,o=0,l=/(?<doubleQuote>"[^"]+")|(?<singleQuote>'[^']+')|(?<singleParam>\([^),]+\)\s*=>)|(?<trailingComma>,\s*[\]}])/g,c={doubleQuote:0,singleQuote:0,singleParam:0,trailingComma:0},u=(i||"").split(`
`),h=!1;for(let f of u){let d=f.trim();if(d.length!==0){if(e.wrapColumn&&f.length>a&&(a=f.length),e.indent){let p=f.match(/^\s+/)?.[0]||"";p.length>0&&(p.length>0&&p.length<t&&(t=p.length),p[0]==="	"?r++:p.length>0&&r--)}if(d.at(-1)===";"?n++:d.length>0&&n--,e.quote||e.arrowParens){let p=d.matchAll(l);for(let g of p)if(g.groups)for(let y in c)g.groups[y]&&c[y]++}e.trailingComma&&((f.startsWith("}")||f.startsWith("]"))&&(h?o++:o--),h=d.endsWith(","))}}return{wrapColumn:a,useTabs:r>0,tabWidth:t,quote:c.singleQuote>c.doubleQuote?"single":"double",arrowParensAlways:c.singleParam>0,trailingComma:o>0||c.trailingComma>0,useSemi:n>0,arrayBracketSpacing:void 0,objectCurlySpacing:void 0,...s}}function Yn(i,s){let e=Bn(i,{parser:s?.parser||Kn(),...s});return _c(e,i)}function Zn(i,s){let e=Bn("("+i+")",{parser:s?.parser||Kn(),...s}),t=e.program.body[0];t.type==="ExpressionStatement"&&(t=t.expression),t.extra?.parenthesized&&(t.extra.parenthesized=!1);let r={$ast:e,$code:" "+i+" ",$type:"module"};return oe(t,r)}function qr(i,s={}){let e=i.$ast||i,t=s.format===!1||!("$code"in i)?{}:Qn(i.$code,s.format),{code:r,map:n}=bc(e,{...s,...t});return{code:r,map:n}}async function jc(i,s={}){let e=await Ir.readFile(i,"utf8");return s.sourceFileName=s.sourceFileName??i,Yn(e,s)}async function Rc(i,s,e){let t="$ast"in i?i.$ast:i,{code:r,map:n}=qr(t,e);await Ir.writeFile(s,r),n&&await Ir.writeFile(s+".map",n)}var hs=mt,Uc={functionCall(i,...s){let e=hs.callExpression(hs.identifier(i),s.map(t=>le(t)));return Xn(e)},newExpression(i,...s){let e=hs.newExpression(hs.identifier(i),s.map(t=>le(t)));return Gn(e)},literal(i){return le(i)},raw(i){return Zn(i)}};import*as $e from"@sentry/node";var Vc="1.6.16",ea=process.env.OVERRIDE_VERSION??Vc;async function ra(i,s){let e=await sa(i,{withFileTypes:!0}),t=[];for(let r of e){let n=$.join(i,r.name);if(r.isDirectory()){if(!s.has(r.name)){let a=await ra(n,s);t.push(...a)}}else t.push(n)}return t}async function ru(i){let s=new Set,e=(...c)=>{if(process.env.DEBUG){let u=new Date,h=`${String(u.getMinutes()).padStart(2,"0")}:${String(u.getSeconds()).padStart(2,"0")}.${String(u.getMilliseconds()).padStart(3,"0")}`;console.debug(h,"[builder-dev-tools]",...c)}},t=async c=>{let u=Hc("md5");return u.update(c),u.digest("hex")},r=$.normalize(i.cwd),n=lu($.normalize(i.cwd))??r,a=cu($.normalize(i.cwd))??n,o={...$,getCwdDir:()=>r,getRepoRootDir:()=>n,getAppRootDir:()=>a,cwd:()=>process.cwd(),exists:async c=>{try{return await $c(c),!0}catch{return!1}},magicast:zr,existsSync:c=>ce(c),readdir:async(c,u)=>{let h=await sa(c);return u?h.map(f=>$.join(c,f)):h},readdirRecursive:async(c,u)=>ra(c,new Set(u)),readdirSync:c=>Xc(c),readFile:async c=>{try{return await zc(c,"utf-8")}catch(u){if(u.code==="ENOENT")return null;throw e(u,c),u}},readFileSync(c){try{return Gc(c,"utf-8")}catch(u){if(u.code==="ENOENT")return null;throw e(u,c),u}},spawnSync:qt,stat:async c=>await Wc(c),statSync:c=>Qc(c),unlinkSync:c=>{Yc(c)},unlink:async c=>{await Jc(c)},writeFile:async(c,u)=>{c=$.normalize(c);let h={path:c,basename:$.basename(c),dirname:$.dirname(c),extname:$.extname(c)};await qc($.dirname(c),{recursive:!0}),await Kc(c,u);for(let f of s)await f(h)},hash:t,getDeviceId:()=>t(`${eu()}:${Zc()}`),formatCode:async(c,u)=>{let h=null;try{h=await ta.resolveConfig(c)}catch{}try{return ta.format(u,{...h,filepath:c})}catch{}return u},on:(c,u)=>{c==="change"&&s.add(u)},off:(c,u)=>{c==="change"&&s.delete(u)},debug:e,launchEditor:async c=>{try{let u=c.filePath;typeof c.line=="number"&&(u+=`:${c.line}`,typeof c.column=="number"&&(u+=`:${c.column}`)),su(u,"code",(h,f)=>{$e.captureException(new Error(`Failed to launch editor for ${f}`),{extra:{pathFile:h}})})}catch(u){$e.captureException(new Error("Failed to launch editor",{cause:u}))}},platform:()=>({runtime:"node",os:process.platform}),getRepoInfo:async()=>{let c=$.normalize(i.cwd);return{remoteUrl:iu(c),defaultBranch:nu(c),commit:au(c),currentBranch:ou(c)}},getFrameworks:()=>[],ts:tu,Sentry:$e,version:ea,sdkVersion:null,ignoreMissingConfig:i.ignoreMissingConfig,kind:null},l=await Yr(o);return o.getFrameworks=()=>l,o}function iu(i){try{return(qt("git",["config","--get","remote.origin.url"],{cwd:i}).stdout||"").toString().trim()}catch(s){return $e.captureException(new Error("Error getting git remote URL:",{cause:s})),""}}function nu(i){let s="master";try{let e=qt("git",["branch","-r"],{cwd:i});return e.stdout&&e.stdout.toString().trim().split(`
`).map(r=>r.trim()).includes("origin/main")?"main":s}catch(e){return $e.captureException(new Error("Error getting git default branch name:",{cause:e})),s}}function au(i){try{return(qt("git",["rev-parse","HEAD"],{cwd:i}).stdout||"").toString().trim()}catch(s){return $e.captureException(new Error("Error getting git commit:",{cause:s})),""}}function ou(i){try{return(qt("git",["branch","--show-current"],{cwd:i}).stdout||"").toString().trim()}catch(s){return $e.captureException(new Error("Error getting current branch name:",{cause:s})),""}}function lu(i){let s=$.resolve("/");for(let e=0;e<20;e++){let t=$.join(i,"package.json");if(ce(t))return i;if(i===s)break;i=$.dirname(i)}return null}function cu(i){let s=$.resolve("/");for(let e=0;e<20;e++){if(ce($.join(i,"package.json"))||ce($.join(i,"remix.config.js"))||ce($.join(i,"remix.config.mjs"))||ce($.join(i,"remix.config.ts"))||ce($.join(i,"vite.config.js"))||ce($.join(i,"vite.config.ts"))||ce($.join(i,"vite.config.mjs"))||ce($.join(i,"next.config.js"))||ce($.join(i,"next.config.ts"))||ce($.join(i,"angular.json"))||ce($.join(i,"project.json"))||ce($.join(i,"tsconfig.json")))return i;if(i===s)break;i=$.dirname(i)}return null}export{ru as createDevToolsNodeSys};
