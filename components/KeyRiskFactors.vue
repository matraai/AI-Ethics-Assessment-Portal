...
<path d="M0 0H20V16H0V0Z" fill="white"></path>
      ...
      },
      {
        ...
        riskLevel: 'Low',
        icon: '<svg id="4:958" layer-name="Frame" width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[14px] h-[16px]">
<g clip-path="url(#clip0_4_958)">
<path d="M4.5 4.5V6H9.5V4.5C9.5 3.11875 8.38125 2 7 2C5.61875 2 4.5 3.11875 4.5 4.5ZM2.5 6V4.5C2.5 2.01562 4.51562 0 7 0C9.48438 0 11.5 2.01562 11.5 4.5V6H12C13.1031 6 14 6.89687 14 8V14C14 15.1031 13.1031 16 12 16H2C0.896875 16 0 15.1031 0 14V8C0 6.89687 0.896875 6 2 6H2.5Z" fill="#10B981"></path>
</g>
<defs>
