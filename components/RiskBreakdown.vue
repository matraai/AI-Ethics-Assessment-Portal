...
export default defineComponent({
  ...
  setup() {
    const breakdownItems = ref<RiskBreakdownItemType[]>([
      {
        title: "Proceedural Risk",
        riskLevel: "High",
        percentage: 85,
        details: [
          "Is the Project within an area of intense public scrutiny, or frequent litigation? - Yes [Med]",
          "Are clients in this line of business particularly vulnerable? - No",
          "Are the stakes of decisions very high - No",
          "Will this project have major impacts on staff, either in terms of numbers of their roles? - Yes [Med]",
          "Will you require new policy authority for this project? - Yes [High]",
          "The algorithm used will be a (trade) secret - No",
          "The algorithmic process will be difficult to interpret or to explain - Yes [High]",
          ". . .",
        ],
      },
      {
